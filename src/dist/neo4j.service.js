...
var Neo4jService = /** @class */ (function () {
    function Neo4jService(neo4jDriver) {
        this.neo4jDriver = neo4jDriver;
    }
    Neo4jService.prototype.someDatabaseOperation = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        ////operaciones a usar en la databaselabera
    ...
    Neo4jService = __decorate([
        common_1.Injectable(),
        __param(0, common_1.Inject('NEO4J_DRIVER'))
    ], Neo4jService);
    return Neo4jService;
}());
