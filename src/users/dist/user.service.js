...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.create = function (createUserDto) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        createdUser = new this.userModel(createUserDto);
    ...
    UserService.prototype.findUsernameByEmail = function (email) {
        return __awaiter(this, void 0, Promise, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    UserService.prototype.validateUser = function (username, pass) {
        return __awaiter(this, void 0, Promise, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
