...
var ProductsService = /** @class */ (function () {
    ...
    ProductsService.prototype.create = function (createProductDto) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        createdProduct = new this.productModel(createProductDto);
                        return [4 /*yield*/, createdProduct.save()];
    ...
    ProductsService.prototype.findAll = function () {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productModel.find().exec()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    ProductsService.prototype.findOne = function (id) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productModel.findById(id).exec()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    ProductsService.prototype.update = function (id, updateProductDto) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productModel.findByIdAndUpdate(id, updateProductDto, { "new": true }).exec()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
