...
var ProductsController = /** @class */ (function () {
    ...
    ProductsController.prototype.create = function (createProductDto) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.productsService.create(createProductDto)];
            });
        });
    };
    ProductsController.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.productsService.findAll()];
            });
        });
    };
    ...
    ProductsController.prototype.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.productsService.findOne(id)];
            });
        });
    };
    ProductsController.prototype.update = function (id, updateProductDto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.productsService.update(id, updateProductDto)];
            });
        });
    };
    ProductsController.prototype["delete"] = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.productsService["delete"](id)];
            });
        });
    };
